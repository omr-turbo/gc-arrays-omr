...
#if !defined(OMR_GC_MARKINGDELEGATE_HPP_)
#define OMR_GC_MARKINGDELEGATE_HPP_
...
using MM_MarkingDelegate = OMR::GC::MarkingDelegate;

#endif /* OMR_GC_MARKINGDELEGATE_HPP_ */
